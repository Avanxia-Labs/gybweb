...
import { textColors, badges, textSize, buttons } from '@/styles/constants'

function Section2() {
    return (
        <div className=' h-screen w-full px-[2.5rem] py-[7.5rem] flex justify-center'>
            ...
            <div id='container' className=' w-full max-w-[58rem] flex flex-col items-center gap-[2.5rem]'>
                ...
                <div id='Frame1299' className='flex flex-col gap-[1rem] items-center'>
                    <p className={`italic font-normal leading-[120%] font-ibm ${textColors.neutralGrey50} ${textSize.size25}`}>The 4 Pillars of GYB</p>
                    <p className={`font-bold text-center leading-[120%] font-ibm ${textColors.darkGreen} ${textSize.size49}`}>Your business deserves more than just a payment processor... </p>
                </div>
                ...
                <div id='Frame1300' className='flex flex-row gap-[1rem]'>
                    <div className={`${badges.v1Desktop}`}>
                        ...
                        <p className={`${textSize.size16} ${textColors.neutralBlack100_90} font-inter text-base font-bold leading-[120%]`}>
                            Fair Pricing
                        </p>
                    </div>
                ...
                <div id='Graph' className='relative w-[76.45rem] h-[32.18rem]'>
                    ...
                    <div id='Frame12' className={`absolute top-[4.12rem] flex w-[20.35463rem] p-10 flex-col items-start gap-6 rounded-[1.5995rem] border border-[rgba(255,255,255,0.70)] bg-[linear-gradient(92deg,rgba(110,149,255,0.25)_0%,rgba(216,218,255,0.25)_100.01%)] backdrop-blur-[10.663349151611328px]`}>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size10} font-normal leading-[120%] tracking-[0.1875rem] uppercase`}>Fair Pricing</p>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size13} font-normal leading-[120%]`}>Ditch the flat-rate fees that punish your success. With our Interchange Plus model, your rate goes down as your business grows.</p>
                    </div>
                    ...
                    <div id='Frame1301' className={`absolute top-[17.62rem] left-[14.19rem] flex w-[20.35463rem] p-[2.5rem] flex-col items-start gap-[1.5rem] rounded-[1.5995rem] border-[1.066px] border-white/70 bg-gradient-to-r from-[rgba(141,109,255,0.25)] to-[rgba(244,228,255,0.25)] backdrop-blur-[10.663349151611328px]`}>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size10} font-normal leading-[120%] tracking-[0.1875rem] uppercase`}>All-in-one platform</p>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size13} font-normal leading-[120%]`}>Manage payments, customers, subscriptions, and reports. All from a single dashboard, without switching between apps.</p>
                    </div>
                    ...
                    <div id='Frame1302' className={`absolute top-[2.12rem] right-[10.31rem] flex w-[20.35463rem] p-[2.5rem] flex-col items-start gap-[1.5rem] rounded-[1.5995rem] border-[1.066px] border-white/70 bg-gradient-to-r from-[rgba(255,140,176,0.25)] to-[rgba(253,228,255,0.25)] backdrop-blur-[10.663349151611328px]`}>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size10} font-normal leading-[120%] tracking-[0.1875rem] uppercase`}>fraud management tools</p>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size13} font-normal leading-[120%]`}>Stop reacting to fraud, start anticipating it. Our advanced tools give you the control to stop disputes before they happen.</p>
                    </div>
                    ...
                    <div id='Frame1303' className={`absolute top-[16.62rem] right-[2.7rem] flex w-[20.35463rem] p-[2.5rem] flex-col items-start gap-[1.5rem] rounded-[1.5995rem] border-[1.066px] border-white/70 bg-gradient-to-r from-[rgba(255,101,99,0.25)] to-[rgba(249,239,226,0.25)] backdrop-blur-[10.663349151611328px]`}>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size10} font-normal leading-[120%] tracking-[0.1875rem] uppercase`}>Omnichannel platform</p>
                        <p className={`${textColors.darkGreen} font-inter ${textSize.size13} font-normal leading-[120%]`}>Accept payments in your store, on your website, or by phone, and manage everything from a single smart platform.</p>
                    </div>
                ...
                <button className={`${buttons.buttonCTA}`}>
                    <p className={`${textColors.gybGreen} ${textSize.size16} font-inter font-bold leading-[120%]`}>
