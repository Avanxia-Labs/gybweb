...
function Section3() {
    ...
    const slideData = [
        {
            imageUrl: '/assets/svgs/industries-legal-offices-slide-1.svg',
            title: 'Surcharging',
            subtitle: "100% of your safe, guaranteed",
            path: '/payments'
        },
        {
            imageUrl: '/assets/svgs/industries-legal-offices-slide-2.svg',
            title: 'Dual Pricing',
            subtitle: "The discount as your best tool",
            path: '/payments'
        },
        {
            imageUrl: '/assets/svgs/industries-legal-offices-slide-3.svg',
            title: 'Customer Manager',
            subtitle: "Turn data into relationships",
            path: '/payments'
        },
        {
            imageUrl: '/assets/svgs/industries-legal-offices-slide-4.svg',
        ...
        >
            ...
            <div className={` w-full max-w-[1440px] flex flex-col items-center gap-[1.75rem] md:gap-[2.5rem]`}>
                ...
                <p className={`${theme === 'dark' ? textColors.gray30_dark : textColors.gray30
                    ...
                    GYB can grow your business friction-free, enhancing customer retention with cutting-edge and tailored technologies.
                </p>
