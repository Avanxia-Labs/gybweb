...
function Section1() {
    ...
    const bgTheme = `bg-[url('/assets/images/backgrounds/bg-industries-section1.png')] md:bg-[url('/assets/images/backgrounds/bg-industries-section1.png')] xl:bg-[url('/assets/images/backgrounds/bg-industries-section1.png')]`


    return (
        <div className={`
            ${bgTheme} bg-[center_top_0%] bg-no-repeat
