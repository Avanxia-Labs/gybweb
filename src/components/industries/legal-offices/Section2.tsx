                    ...
                    `}>
                        ...
                        `}>
                            ...
                            <p className={`${theme === 'dark' ? textColors.gray30_dark : textColors.gray30
                                ...
                                Divide large retainers into automatic, easy-to-pay installments for your clients.
                            </p>
                        ...
                        `}>
                            ...
                            <picture className=' block w-full'>
                                ...
                                <source
                                    media="(min-width: 1280px)"
                                    srcSet="/assets/images/industries-legal-offcies-ach1.png"
                                    width="170"
                                    height="176"
                                    className=''
                                ...
                                {/* Mobile (fallback) */}
                                <Image
                                    src="/assets/images/industries-legal-offcies-ach1.png"
                                    alt="paymentplan"
                                    width={170}
                                    height={176}
                                    className=""
                            ...
                            <p className={`${theme === 'dark' ? textColors.gray30_dark : textColors.gray30
                                ...
                                The most cost-effective option for receiving payments for settlements and high-value fees.
                            </p>
